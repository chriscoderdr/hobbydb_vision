...
localize: check_env clean
	flutter pub pub run intl_translation:extract_to_arb --output-dir=./ --no-transformer lib/src/core/localization.dart
	mv intl_messages.arb intl_en.arb
	flutter pub pub run intl_translation:generate_from_arb --no-use-deferred-loading lib/src/core/localization.dart $(FILES)
